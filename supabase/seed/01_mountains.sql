...
values
  ...
  (2, 'leeukop', 'Leeukop', null, 'Western Cape', 'South Africa', 'Moderate',
   ...
   'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&fit=crop&w=1600&q=80', false, true),
  ...
  (3, 'sterrekykerskop', 'Sterrekykerskop', 1200, 'Western Cape', 'South Africa', 'Hard',
   ...
   'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?auto=format&fit=crop&w=1600&q=80', false, true),
  ...
  (4, 'saaltjie', 'Saaltjie', null, 'Western Cape', 'South Africa', 'Moderate',
   ...
   'https://images.unsplash.com/photo-1454496522488-7a8e488e8606?auto=format&fit=crop&w=1600&q=80', false, true),
  ...
  (5, 'paarlberg', 'Paarlberg', 729, 'Paarl', 'South Africa', 'Easy',
   ...
   'https://images.unsplash.com/photo-1501785888041-af3ef285b470?auto=format&fit=crop&w=1600&q=80', false, true),
  ...
  (6, 'guardian-peak', 'Guardian Peak', 1227, 'Helderberg / Jonkershoek', 'South Africa', 'Hard',
   ...
   'https://images.unsplash.com/photo-1469474968028-56623f02e42e?auto=format&fit=crop&w=1600&q=80', false, true),
  ...
  (7, 'spitskop', 'Spitskop', 1287, 'Western Cape', 'South Africa', 'Hard',
   ...
   'https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?auto=format&fit=crop&w=1600&q=80', false, true),
  ...
  (8, 'haelkop', 'Haelkop', 1400, 'Hottentots Holland', 'South Africa', 'Hard',
   ...
   'https://images.unsplash.com/photo-1486870591958-9b9d0d1dda99?auto=format&fit=crop&w=1600&q=80', false, true),
  ...
  (9, 'virgin-peak', 'Virgin Peak', 1460, 'Jonkershoek', 'South Africa', 'Hard',
   ...
   'https://images.unsplash.com/photo-1483728642387-6c3bdd6c93e5?auto=format&fit=crop&w=1600&q=80', false, true),
  ...
  (10, 'the-twins', 'The Twins', 1500, 'Jonkershoek', 'South Africa', 'Strenuous',
   ...
   'https://images.unsplash.com/photo-1458668383970-8ddd3927deed?auto=format&fit=crop&w=1600&q=80', false, true),
  ...
  (11, 'first-ridge-peak', 'First Ridge Peak', null, 'Jonkershoek', 'South Africa', 'Hard',
   ...
   'https://images.unsplash.com/photo-1434394354979-a235cd36269d?auto=format&fit=crop&w=1600&q=80', false, true),
  ...
  (12, 'banghoek-peak', 'Banghoek Peak', null, 'Jonkershoek', 'South Africa', 'Hard',
   ...
   'https://images.unsplash.com/photo-1491555103944-7c647fd857e6?auto=format&fit=crop&w=1600&q=80', false, true),
  ...
  (13, 'dwarsberg', 'Dwarsberg', 1523, 'Jonkershoek', 'South Africa', 'Strenuous',
   ...
   'https://images.unsplash.com/photo-1455156218388-5e61b526818b?auto=format&fit=crop&w=1600&q=80', false, true),
  ...
  (14, 'sneeukop', 'Sneeukop', 1930, 'Cederberg', 'South Africa', 'Strenuous',
   ...
   'https://images.unsplash.com/photo-1439853949127-fa647821eba0?auto=format&fit=crop&w=1600&q=80', false, true),
  ...
  (15, 'sneeuberg', 'Sneeuberg', 2027, 'Cederberg', 'South Africa', 'Strenuous',
   ...
   'https://images.unsplash.com/photo-1519681393784-d120267933ba?auto=format&fit=crop&w=1600&q=80', false, true),
  ...
  (16, 'towerkop', 'Towerkop', 2189, 'Klein Swartberg', 'South Africa', 'Extreme',
   ...
   'https://images.unsplash.com/photo-1500534314209-a25ddb2bd429?auto=format&fit=crop&w=1600&q=80', false, true),
  ...
  (17, 'matroosberg', 'Matroosberg', 2249, 'Hex River Mountains', 'South Africa', 'Hard',
   ...
   'https://images.unsplash.com/photo-1589182373726-e4f658ab50f0?auto=format&fit=crop&w=1600&q=80', false, true),
  ...
  (18, 'seweweekspoort-peak', 'Seweweekspoort Peak', 2325, 'Klein Swartberg', 'South Africa', 'Strenuous',
   ...
   'https://images.unsplash.com/photo-1519904981063-b0cf448d479e?auto=format&fit=crop&w=1600&q=80', false, true),
  ...
  (19, 'groot-winterhoek', 'Groot Winterhoek', 2078, 'Tulbagh / Porterville', 'South Africa', 'Strenuous',
   ...
   'https://images.unsplash.com/photo-1465056836041-7f43ac27dcb5?auto=format&fit=crop&w=1600&q=80', false, true),
